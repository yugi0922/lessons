package org.example.answers.practice1_2;

import org.example.answers.practice1_2.method.PaymentMethodStrategy;
import org.example.answers.practice1_2.method.CreditCardStrategy;
import org.example.answers.practice1_2.method.BankTransferStrategy;
import org.example.answers.practice1_2.method.BTCStrategy;
...
public class PaymentProcessorFactory {
    ...
    public PaymentProcessor getInstance() {
        ...
        } else if(paymentMethod.equals(PaymentMethodType.BTC)) {
            return new PaymentProcessor(new BTCStrategy(accountNumber));
        }
